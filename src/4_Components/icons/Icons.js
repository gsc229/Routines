...
import {GiWeight, GiPathDistance, GiWeightLiftingDown, GiWeightLiftingUp} from 'react-icons/gi'
...
export const EyeIcon = ({onClick}) => <BsEye onClick={onClick} className='icon eye-icon' />
...
export const WeightLiftUpIcon = ({onClick}) => <GiWeightLiftingUp  onClick={onClick} className='icon weight-lift-up-icon'/>
